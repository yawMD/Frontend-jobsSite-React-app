...
function AddManager(props) {
  ...
  const [btnTxt, setBtnTxt] = useState("Add New Manager");
...
//   }, []);
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    let _data = {name, email, phone, password, status: 'active' };
    console.log(_data);
    postData("/admin/user/manager", _data)
  ...
  return (
    <div className="h-screen fixed justify-center content-center flex top-0 left-0 z-50 w-full bg-white bg-opacity-10">
      <form className="my-auto w-1/2" onSubmit={handleSubmit}>
        ...
        <hr className="my-2" />
        <h2 className="text-3xl font-bold">Add New Manager</h2>
        {/* <hr className="my-2" /> */}
        <div className="my-2 p-6 col-s pan-2 md:col-spa n-1">
          ...
          {/* <div className="mt-2">
            <label htmlFor="doc">Manager's Profile Picture</label>
          ...
          <div className="mt-3">
            <label htmlFor="doc">Manager's Documents</label>
